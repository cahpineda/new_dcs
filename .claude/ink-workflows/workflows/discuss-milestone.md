...
**Primary:** `node bin/ink-tools.js phase list` — phases from roadmap
...
Did you want to:
1. Complete current milestone first (/ink:complete-milestone)
2. Add phases to current milestone (/ink:add-phase)
...
- options (ALL THREE REQUIRED):
  - "Create milestone" - Proceed to /ink:new-milestone
...
Use template from .claude/ink-workflows/templates/milestone-context.md
...
Write the context file using the Write tool:
```markdown
# Milestone Context
...
- Context handed off to /ink:new-milestone
</success_criteria>
