...
Roadmaps define what work happens in what order. Run after /ink:new-project.
</objective>

<execution_context>
@.claude/ink-workflows/workflows/create-roadmap.md
@.claude/ink-workflows/templates/roadmap.md
@.claude/ink-workflows/templates/state.md
</execution_context>
...
- If missing, output: `ERROR: No PROJECT.md found. Run /ink:new-project first.` and exit.
</step>
...
**Also available:**
- `/ink:discuss-phase 1` — gather context first
- `/ink:research-phase 1` — investigate unknowns
- Review roadmap
