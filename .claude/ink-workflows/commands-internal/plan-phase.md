...
<execution_context>
@.claude/ink-workflows/workflows/plan-phase.md
@.claude/ink-workflows/templates/phase-prompt.md
@.claude/ink-workflows/references/plan-format.md
@.claude/ink-workflows/references/scope-estimation.md
...
**Load phase context if exists (created by /ink:discuss-phase):**
