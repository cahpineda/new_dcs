...
Output: Context gathered, then routes to /ink:new-milestone
</objective>

<execution_context>
@.claude/ink-workflows/workflows/discuss-milestone.md
</execution_context>
...
4. Hand off to /ink:new-milestone with gathered context
