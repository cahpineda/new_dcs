...
<execution_context>
@.claude/ink-workflows/workflows/resume-task.md
</execution_context>
...
```
/ink:resume-task agent_01HXYZ123
```
...
- Solution: Run /ink:progress to check project status
...
- Solution: Start fresh with /ink:execute-plan
</error_handling>
