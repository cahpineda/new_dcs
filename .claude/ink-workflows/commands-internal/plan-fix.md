...
<execution_context>
@.claude/ink-workflows/references/plan-format.md
...
ISSUES.md files are created by /ink:verify-work when UAT finds issues.
...
If execute: `/ink:execute-plan .planning/phases/XX-name/{plan}-FIX.md`
</step>
