...
- @.claude/ink-workflows/workflows/complete-milestone.md (main workflow)
- @.claude/ink-workflows/templates/milestone-archive.md (archive template)
  </execution_context>
...
7. **Offer next steps:**
   ...
   **Always append:** `💡 Milestone archived. Run /clear to start fresh with clean context.`
