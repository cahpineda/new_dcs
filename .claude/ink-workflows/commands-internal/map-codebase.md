...
<execution_context>
@.claude/ink-workflows/workflows/map-codebase.md
@.claude/ink-workflows/templates/codebase/stack.md
@.claude/ink-workflows/templates/codebase/architecture.md
@.claude/ink-workflows/templates/codebase/structure.md
@.claude/ink-workflows/templates/codebase/conventions.md
@.claude/ink-workflows/templates/codebase/testing.md
@.claude/ink-workflows/templates/codebase/integrations.md
@.claude/ink-workflows/templates/codebase/concerns.md
</execution_context>
...
- Before /ink:new-project (brownfield codebases) - creates codebase map first
- After /ink:new-project (greenfield codebases) - updates codebase map as code evolves
...
6. Offer next steps (typically: /ink:new-project or /ink:plan-phase)
</process>
