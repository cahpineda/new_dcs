...
- All documentation (PROJECT.md, ROADMAP.md, STATE.md, SUMMARY.md, etc.)
- All commit messages
- All code comments
- All user-facing output

Regardless of the language the user speaks, generated artifacts are always in English.
...
See `.claude/ink-workflows/references/git-integration.md` for complete strategy.
</atomic_commits>
