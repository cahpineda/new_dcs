...
**Purpose:** Capture issues found during /ink:verify-work. Unlike global ISSUES.md (for deferred enhancements), this file tracks bugs and problems in specific delivered work.
...
[Moved here after /ink:plan-fix executes and fixes are verified]
...
<guidelines>
**When to create:**
- First time /ink:verify-work finds an issue for a plan
...
**Workflow:**
1. /ink:verify-work creates this file with issues
2. /ink:plan-fix reads this file and creates FIX.md plan
