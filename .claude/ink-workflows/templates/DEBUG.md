...
mechanism: [WHY it works - empty until understood]
verification: [empty until verified - e.g., "Symptoms resolved, tests pass, login feature verified"]
files_changed: []
```
...
**Creation:** Immediately when /ink:debug is called
...
**During verification:**
- status → "verifying"
- Verify symptoms resolved, tests pass, adjacent feature works
- Update Resolution.verification with summary
