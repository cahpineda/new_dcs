...
**Purpose:** Persist milestone discussion context so `/clear` can be used between commands. This file is consumed by `/ink:new-milestone` and deleted after the milestone is created.
...
**Generated:** [date]
**Status:** Ready for /ink:new-milestone
...
*This file is temporary. It will be deleted after /ink:new-milestone creates the milestone.*
```
...
**Lifecycle:**
1. `/ink:discuss-milestone` creates this file at end of discussion
2. User runs `/clear` (safe now - context is persisted)
3. `/ink:new-milestone` reads this file
4. `/ink:new-milestone` uses context to populate milestone
5. `/ink:new-milestone` deletes this file after successful creation
