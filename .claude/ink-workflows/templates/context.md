...
Decisions confirmed during discuss phase. The planner MUST treat these as constraints, not suggestions.

### [Category Name]

| # | Decision | Evidence | Status |
|---|----------|----------|--------|
| 1 | [What was decided] | [File path or "user stated"] | locked |
| 2 | [What was decided] | [Evidence source] | locked |

[Repeat per category as needed]
...
Gray areas intentionally left for the planner to decide based on technical analysis.

- [Item 1: why deferred]
- [Item 2: why deferred]

[If none: "No deferred items — all decisions locked"]
...
**Locked decisions are CONSTRAINTS for the planner, not suggestions.**

- Evidence field helps the planner understand WHY a decision was made
- Deferred items are explicitly marked so the planner knows they have latitude
- CONTEXT.md from Q&A mode has vision sections + locked decisions from stated decisions
- CONTEXT.md from Assumptions Mode has locked decisions as primary content (vision sections may be minimal)
