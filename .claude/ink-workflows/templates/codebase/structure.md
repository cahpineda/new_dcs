...
│   └── ink/           # Ink-specific commands
├── ink-workflows/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/ink:{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `ink-workflows/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `ink-workflows/workflows/{name}.md`
- Usage: Reference from command with `@.claude/ink-workflows/workflows/{name}.md`

**New Reference Document:**
- Implementation: `ink-workflows/references/{name}.md`
